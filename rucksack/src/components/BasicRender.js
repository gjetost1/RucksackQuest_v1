...
const innerBoundary = [
  ...
  {x: width / 2 - blockSize * 8, y: 228, xBlocks: 16, yBlocks: 2, gridSize: blockSize},
  {x: width / 2 - blockSize * 7, y: 340, xBlocks: 18, yBlocks: 1, gridSize: blockSize},
  {x: width / 2 + blockSize * 7, y: 340, xBlocks: 1, yBlocks: 8, gridSize: blockSize},
  {x: width / 2 + blockSize * 2, y: 120, xBlocks: 1, yBlocks: 16, gridSize: blockSize},
